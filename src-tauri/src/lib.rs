...
pub(crate) fn mood_settings_to_params(m: &voxelle::MoodSettings) -> MoodParams {
    MoodParams {
        ...
        ts_blur_strength: m.ts_blur_strength,
        ts_center_y: m.ts_center_y,
        ts_enabled: m.ts_enabled,
        ts_focus_width: m.ts_focus_width,
        ts_rotation: m.ts_rotation,
...
pub fn run() {
    ...
    let viewer_state = Arc::new(ViewerState {
        ...
        file: FileState {
            ...
            stroke_preview_generation: AtomicU64::new(0),
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            extrude_sync_endpoint_gizmo_from_preview,
            extrude_preview_set_endpoint,
