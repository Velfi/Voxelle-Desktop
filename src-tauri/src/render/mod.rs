...
pub struct WgpuViewer {
    ...
    pub(crate) preview_solid_instance_capacity: u32,
    pub(crate) preview_wire_instance_buf: Option<wgpu::Buffer>,
    pub(crate) preview_wire_instance_count: u32,
    pub(crate) preview_wire_instance_capacity: u32,
    pub(crate) preview_proto_cube_half: Option<f32>,
    ...
    pub(crate) gen_preview_solid_instance_capacity: u32,
    pub(crate) gen_preview_wire_instance_buf: Option<wgpu::Buffer>,
    pub(crate) gen_preview_wire_instance_count: u32,
    pub(crate) gen_preview_wire_instance_capacity: u32,
    pub(crate) gen_preview_proto_cube_half: Option<f32>,
...
impl WgpuViewer {
    pub async fn new(window: impl wgpu::WindowHandle + 'static) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            preview_solid_instance_capacity: 0,
            preview_wire_instance_buf: None,
            preview_wire_instance_count: 0,
            preview_wire_instance_capacity: 0,
            preview_proto_cube_half: None,
            ...
            gen_preview_solid_instance_capacity: 0,
            gen_preview_wire_instance_buf: None,
            gen_preview_wire_instance_count: 0,
            gen_preview_wire_instance_capacity: 0,
            gen_preview_proto_cube_half: None,
